...
/**
  ...
  */
case class User(id: String, username: String, discriminator: String, avatar: String, bot: Boolean, mfa_enabled: Boolean, verified: Option[Boolean], email: Option[String]) {
